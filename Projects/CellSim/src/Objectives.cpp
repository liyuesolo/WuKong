...
T ObjUTU::value(const VectorXT& p_curr)
{
    simulation.reset();
...
T ObjUTU::gradient(const VectorXT& p_curr, VectorXT& dOdp)
{
    simulation.reset();
    updateDesignParameters(p_curr);
    simulation.staticSolve();
...
T ObjUTU::gradient(const VectorXT& p_curr, VectorXT& dOdp, T& energy)
{
    simulation.reset();
    updateDesignParameters(p_curr);
    simulation.staticSolve();
