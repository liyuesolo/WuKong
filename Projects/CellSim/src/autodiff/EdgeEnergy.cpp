...
void computeEdgeEnergyRestLength3DGradient(double stiffness, double l0, const Eigen::Matrix<double,6,1> & x, Eigen::Matrix<double, 6, 1>& energygradient){
	...
	_i_var[9] = (l0)-(_i_var[8]);
	_i_var[10] = 2;
	_i_var[11] = (stiffness)*(_i_var[9]);
	_i_var[12] = (_i_var[10])*(_i_var[8]);
	_i_var[13] = 1;
	_i_var[14] = -1;
	_i_var[15] = (_i_var[10])*(_i_var[11]);
	_i_var[16] = (_i_var[13])/(_i_var[12]);
	_i_var[17] = (_i_var[15])*(_i_var[14]);
	_i_var[18] = (_i_var[17])*(_i_var[16]);
	_i_var[19] = (_i_var[18])*(_i_var[1]);
	_i_var[20] = (_i_var[18])*(_i_var[0]);
	_i_var[21] = (_i_var[18])*(_i_var[2]);
	_i_var[22] = (_i_var[10])*(_i_var[19]);
	_i_var[23] = (_i_var[10])*(_i_var[20]);
	_i_var[24] = (_i_var[10])*(_i_var[21]);
	_i_var[25] = (_i_var[22])*(_i_var[14]);
	_i_var[26] = (_i_var[23])*(_i_var[14]);
	_i_var[27] = (_i_var[24])*(_i_var[14]);
	energygradient(0,0) = _i_var[25];
	energygradient(1,0) = _i_var[26];
	energygradient(2,0) = _i_var[27];
	energygradient(3,0) = _i_var[22];
	energygradient(4,0) = _i_var[23];
	energygradient(5,0) = _i_var[24];
}
void computeEdgeEnergyRestLength3DHessian(double stiffness, double l0, const Eigen::Matrix<double,6,1> & x, Eigen::Matrix<double, 6, 6>& energyhessian){
	...
	_i_var[12] = 1;
	_i_var[13] = (_i_var[12])/(_i_var[11]);
	_i_var[14] = (l0)-(_i_var[8]);
	_i_var[15] = -(_i_var[13]);
	_i_var[16] = (_i_var[9])*(_i_var[14]);
	_i_var[17] = (_i_var[12])/(_i_var[10]);
	_i_var[18] = (_i_var[15])*(_i_var[9]);
	_i_var[19] = -1;
	_i_var[20] = (stiffness)*(_i_var[16]);
	_i_var[21] = (_i_var[18])*(_i_var[17]);
	_i_var[22] = (_i_var[20])*(_i_var[19]);
	_i_var[23] = (stiffness)*(_i_var[9]);
	_i_var[24] = (_i_var[17])*(_i_var[17]);
	_i_var[25] = (_i_var[22])*(_i_var[21]);
	_i_var[26] = (_i_var[24])*(_i_var[23]);
	_i_var[27] = (_i_var[26])+(_i_var[25]);
	_i_var[28] = (_i_var[9])*(_i_var[1]);
	_i_var[29] = (_i_var[9])*(_i_var[2]);
	_i_var[30] = (_i_var[9])*(_i_var[0]);
	_i_var[31] = (_i_var[28])*(_i_var[27]);
	_i_var[32] = (_i_var[29])*(_i_var[27]);
	_i_var[33] = (_i_var[22])*(_i_var[17]);
	_i_var[34] = (_i_var[28])*(_i_var[28]);
	_i_var[35] = (_i_var[30])*(_i_var[30]);
	_i_var[36] = (_i_var[29])*(_i_var[29]);
	_i_var[37] = (_i_var[30])*(_i_var[31]);
	_i_var[38] = (_i_var[28])*(_i_var[32]);
	_i_var[39] = (_i_var[33])*(_i_var[9]);
	_i_var[40] = (_i_var[34])*(_i_var[27]);
	_i_var[41] = (_i_var[30])*(_i_var[32]);
	_i_var[42] = (_i_var[35])*(_i_var[27]);
	_i_var[43] = (_i_var[36])*(_i_var[27]);
	_i_var[44] = (_i_var[19])*(_i_var[37]);
	_i_var[45] = (_i_var[19])*(_i_var[38]);
	_i_var[46] = (_i_var[40])+(_i_var[39]);
	_i_var[47] = (_i_var[19])*(_i_var[41]);
	_i_var[48] = (_i_var[42])+(_i_var[39]);
	_i_var[49] = (_i_var[43])+(_i_var[39]);
	_i_var[50] = (_i_var[19])*(_i_var[44]);
	_i_var[51] = (_i_var[19])*(_i_var[45]);
	_i_var[52] = (_i_var[19])*(_i_var[46]);
	_i_var[53] = (_i_var[19])*(_i_var[47]);
	_i_var[54] = (_i_var[19])*(_i_var[48]);
	_i_var[55] = (_i_var[19])*(_i_var[49]);
	energyhessian(0,0) = _i_var[46];
	energyhessian(1,0) = _i_var[50];
	energyhessian(2,0) = _i_var[51];
	energyhessian(3,0) = _i_var[52];
	energyhessian(4,0) = _i_var[44];
	energyhessian(5,0) = _i_var[45];
	energyhessian(0,1) = _i_var[50];
	energyhessian(1,1) = _i_var[48];
	energyhessian(2,1) = _i_var[53];
	energyhessian(3,1) = _i_var[44];
	energyhessian(4,1) = _i_var[54];
	energyhessian(5,1) = _i_var[47];
	energyhessian(0,2) = _i_var[51];
	energyhessian(1,2) = _i_var[53];
	energyhessian(2,2) = _i_var[49];
	energyhessian(3,2) = _i_var[45];
	energyhessian(4,2) = _i_var[47];
	energyhessian(5,2) = _i_var[55];
	energyhessian(0,3) = _i_var[52];
	energyhessian(1,3) = _i_var[44];
	energyhessian(2,3) = _i_var[45];
	energyhessian(3,3) = _i_var[46];
	energyhessian(4,3) = _i_var[37];
	energyhessian(5,3) = _i_var[38];
	energyhessian(0,4) = _i_var[44];
	energyhessian(1,4) = _i_var[54];
	energyhessian(2,4) = _i_var[47];
	energyhessian(3,4) = _i_var[37];
	energyhessian(4,4) = _i_var[48];
	energyhessian(5,4) = _i_var[41];
	energyhessian(0,5) = _i_var[45];
	energyhessian(1,5) = _i_var[47];
	energyhessian(2,5) = _i_var[55];
	energyhessian(3,5) = _i_var[38];
	energyhessian(4,5) = _i_var[41];
