...
void FEMSolver::addBCPenaltyEnergy(T& energy)
{
...
void FEMSolver::addBCPenaltyForceEntries(VectorXT& residual)
{
    iterateBCPenaltyPairs([&](int offset, T target)
    {
...
void FEMSolver::addBCPenaltyHessianEntries(std::vector<Entry>& entries)
{
    iterateBCPenaltyPairs([&](int offset, T target)
    {
