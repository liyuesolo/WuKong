#include "../include/SoftPenalty.h"

SoftUnilateralConstraint::SoftUnilateralConstraint(double l, double stiffness,
                                                   double epsilon) {
    this->limit = l;
...
void SoftUnilateralConstraint::setLimit(double l) { limit = l; }
...
SoftBoundConstraint::SoftBoundConstraint(double lLimit, double uLimit,
                                         double relEps, double stiffness)
...
SoftSymmetricBarrierConstraint::SoftSymmetricBarrierConstraint(double limit)
    : SoftBoundConstraint(-fabs(limit), fabs(limit)) {}