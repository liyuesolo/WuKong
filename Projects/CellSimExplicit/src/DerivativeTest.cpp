...
void CellSim::checkTotalGradient(bool perturb)
{
...
void CellSim::checkTotalHessian(bool perturb)
{
...
void CellSim::checkTotalGradientScale(bool perturb)
{
...
void CellSim::checkTotalHessianScale(bool perturb)
{
