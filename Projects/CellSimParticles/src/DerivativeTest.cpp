...
template <int dim>
void CellSim<dim>::checkTotalGradient(bool perturb)
{
...
template <int dim>
void CellSim<dim>::checkTotalHessian(bool perturb)
{
    run_diff_test = true;
...
template <int dim>
void CellSim<dim>::checkTotalGradientScale(bool perturb)
{
...
template <int dim>
void CellSim<dim>::checkTotalHessianScale(bool perturb)
{
