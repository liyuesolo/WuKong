...
public:
    ...
    CellFunctionSecondMomentScaled moment_function;
...
public:
    CellFunctionEnergy(Foam2DInfo *info) : CellFunctionWeightedSum() {
        ...
        functions.push_back(&moment_function);
        weights.push_back(info->energy_deformation_moment_weight);
        ...
        functions.push_back(&adhesion_function);
        weights.push_back(info->energy_adhesion_weight);
    };
};
