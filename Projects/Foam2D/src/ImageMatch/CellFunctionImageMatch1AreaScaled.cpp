...
void CellFunctionImageMatch1AreaScaled::addValue(const VectorXT &site, const VectorXT &nodes, double &value,
...
void CellFunctionImageMatch1AreaScaled::addGradient(const VectorXT &site, const VectorXT &nodes, VectorXT &gradient_c,
...
void CellFunctionImageMatch1AreaScaled::addHessian(const VectorXT &site, const VectorXT &nodes, MatrixXT &hessian,
                                            const CellInfo *cellInfo) const {
    double area = 0;
    area_function.addValue(site, nodes, area, cellInfo);
    double image_match = 0;
