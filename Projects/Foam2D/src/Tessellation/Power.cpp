...
void Power::getBoundaryNodeGradient(const VectorXT &v1, const VectorXT &v2, const TV &b0, const TV &b1, VectorXT &gradX,
    ...
    t4 = -t1 * (v1x - v2x) - t2 * t3;
    t5 = 0.1e1 / 0.2e1;
    t6 = t5 * (zmul * (-v2z + v1z) + v1y * v1y + v1x * v1x - v2y * v2y - v2x * v2x);
    t4 = 0.1e1 / t4;
    ...
    gradX[1] = t4 * (t2 - (y4 - v1y) * x3 + (-v1y + y3) * x4);
    gradX[2] = t3;
    gradX[3] = -t4 * (-v2x * t1 + t6);
    gradX[4] = -t4 * (t2 - (-v2y + y4) * x3 + (y3 - v2y) * x4);
    gradX[5] = -t3;
    ...
    t4 = t3 * (-v2y + v1y) - t1 * t2;
    t5 = 0.1e1 / 0.2e1;
    t6 = t5 * (-(-v2z + v1z) * zmul - v1y * v1y - v1x * v1x + v2y * v2y + v2x * v2x);
    t4 = 0.1e1 / t4;
    t1 = ((-x4 * t1 - t6) * y3 + (x3 * t1 + t6) * y4) * t4;
    t2 = t1 * t2;
    t1 = -t1 * t3;
    t5 = t5 * zmul * t3 * t4;
    gradY[0] = t4 * (t2 - (x4 - v1x) * y3 + (-v1x + x3) * y4);
    gradY[1] = t4 * (v1y * t3 + t1);
    gradY[2] = t5;
    gradY[3] = -t4 * (t2 - (-v2x + x4) * y3 + (x3 - v2x) * y4);
...
void Power::getBoundaryNodeHessian(const VectorXT &v1, const VectorXT &v2, const TV &b0, const TV &b1, MatrixXT &hessX,
    ...
    t5 = v1x * t1;
    t6 = 0.1e1 / 0.2e1;
    t7 = t6 * ((-v2z + v1z) * zmul + v1y * v1y + v1x * v1x - v2y * v2y - v2x * v2x);
    ...
    t17 = -zmul * t1;
    t18 = v2x * t1;
    t19 = -t14 * pow(t1, 0.2e1) + t10 * (t5 + t18);
    ...
    t22 = t18 * t3;
    t12 = -t15 + t7 * (t22 + t12);
    t3 = -t14 * pow(t3, 0.2e1) + t4 * (t11 + t20);
    t6 = t4 * t6 * t17;
    t1 = t15 - t7 * (t22 + t1);
    ...
    hessX_c[3][1] = t12;
    hessX_c[3][2] = -t21;
    hessX_c[3][3] = 0.2e1 * t10 * (t9 - t18) + t8;
    hessX_c[3][4] = t1;
    hessX_c[3][5] = t21;
    hessX_c[4][0] = t13;
    hessX_c[4][1] = t3;
    ...
    t16 = -t7 * (t14 + t15) + t4;
    t17 = -zmul * t1;
    t18 = (-v2x + x4) * y3 - (x3 - v2x) * y4;
    t19 = t10 * (t5 + t18) - t2 * pow(t3, 0.2e1);
    t20 = v2y * t1;
    t3 = t20 * t3;
    t14 = t7 * (t14 + t3) - t4;
    t21 = t10 * t6 * t17;
    ...
    t23 = t18 * t1;
    t15 = t7 * (t23 + t15) - t4;
    t1 = t22 * (t13 + t20) - t2 * pow(t1, 0.2e1);
    t2 = t22 * t6 * t17;
    t3 = -t7 * (t23 + t3) + t4;
    hessY_c[0][0] = t11 * t10 * (-t5 + t9) - t12;
    hessY_c[0][1] = t16;
    hessY_c[0][2] = t21;
    hessY_c[0][3] = t19;
    hessY_c[0][4] = t14;
    hessY_c[0][5] = -t21;
    hessY_c[1][0] = t16;
    hessY_c[1][1] = t11 * t22 * (-t13 + t8) - t12;
    hessY_c[1][2] = t2;
    hessY_c[1][3] = t15;
    hessY_c[1][4] = t1;
    hessY_c[1][5] = -t2;
    ...
    hessY_c[3][1] = t15;
    hessY_c[3][2] = -t21;
    hessY_c[3][3] = -t11 * t10 * (t18 - t9) + t12;
    hessY_c[3][4] = t3;
    hessY_c[3][5] = t21;
    hessY_c[4][0] = t14;
    hessY_c[4][1] = t1;
    hessY_c[4][2] = -t2;
    hessY_c[4][3] = t3;
    hessY_c[4][4] = t11 * t22 * (-t20 + t8) + t12;
    hessY_c[4][5] = t2;
    hessY_c[5][0] = -t21;
    hessY_c[5][1] = -t2;
    hessY_c[5][2] = 0;
