...
void
CellFunctionWeightedMeanX::addValue(const VectorXT &site, const VectorXT &nodes, const VectorXi &next, double &value,
...
void CellFunctionWeightedMeanX::addGradient(const VectorXT &site, const VectorXT &nodes, const VectorXi &next,
    ...
    for (int i = 0; i < n_nodes; i++) {
        ...
        if (fabs(r) > 1e-10) {
            ...
            gradient_x(y1i) += -t3;
            gradient_x(ri) +=
                    t20 * r * (-r * t18 * t5 * t6 * t9 + t19) / 0.2e1 + t22 * t2 * t11 * (t7 * t9 + t8) * t17 * t19;
        }
    }
}
...
//    MatrixXT hess_xx = MatrixXT::Zero(nodes.rows(), nodes.rows());
    ...
    for (int i = 0; i < n_nodes; i++) {
        ...
        if (fabs(r) > 1e-10) {
            ...
            t69 = -r * t31 * t8 * t16 * t41;
            t70 = -t69 + t35;
            t11 = t67 * (t11 + t18) * r;
            t71 = t11 * t43;
            t72 = t44 * r;
            t73 = t72 * t43;
            t74 = t24 * r * (t39 * t70 - t71) + t52 * t49 * (t44 * t68 + t1) - t73;
            ...
            hess_xx(ri, x1i) += t1;
            hess_xx(ri, y1i) += t3;
            hess_xx(ri, ri) += t44 * (t24 * t35 - t69 * t32) + t52 * t49 * (-t35 * t67 * t6 * t10 * (t19 + t16) + t44 *
                                                                                                                  (-t32 *
                                                                                                                   t30 *
                                                                                                                   t7 *
                                                                                                                   t9 *
